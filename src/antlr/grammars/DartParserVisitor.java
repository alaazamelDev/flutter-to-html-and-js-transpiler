...
public interface DartParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code CustomWidgetDeclarationStatement}
	 * labeled alternative in {@link DartParser#statment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCustomWidgetDeclarationStatement(DartParser.CustomWidgetDeclarationStatementContext ctx);
	/**
