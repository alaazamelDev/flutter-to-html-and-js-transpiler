...
public class DartParser extends Parser {
	...
	public final RowPropertiesContext rowProperties() throws RecognitionException {
		...
		try {
			...
			case CHILDREN:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 60223488L) != 0 || _la==WIDGETNAME) {
					{
					{
					setState(184);
					widget();
	...
	public final TextContext text() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la - 35)) & ~0x3f) == 0 && ((1L << (_la - 35)) & 34359738397L) != 0) {
				{
				setState(247);
				textProperties();
				setState(252);
	...
	public final TextPropertiesContext textProperties() throws RecognitionException {
		...
		try {
			...
			case FONTWEIGHT:
				...
				setState(264);
				_la = _input.LA(1);
				if ( !((((_la - 40)) & ~0x3f) == 0 && ((1L << (_la - 40)) & 481036337153L) != 0) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
			...
			case TEXTALIGN:
				...
				setState(273);
				_la = _input.LA(1);
				if ( !((((_la - 44)) & ~0x3f) == 0 && ((1L << (_la - 44)) & 1879048193L) != 0) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ContainerContext container() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 1141293338066944L) != 0) {
				{
				setState(278);
				containerProperties();
				setState(283);
	...
	public final ExpandedContext expanded() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 41781710290944L) != 0) {
				{
				setState(361);
				expandedProperties();
				setState(366);
	...
	public final ImageContext image() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 6917535624710848512L) != 0) {
				{
				setState(494);
				imageProperties();
				setState(499);
	...
	public final ButtonContext button() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la - 41)) & ~0x3f) == 0 && ((1L << (_la - 41)) & 1103101955L) != 0) {
				{
				setState(522);
				buttonProperties();
				setState(527);
	...
	public final VariablesContext variables() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 24696061952L) != 0) {
				{
				{
				setState(564);
				variableDeclaration();
